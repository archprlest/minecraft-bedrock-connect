...
curl  --silent -L https://github.com/Pugmatt/BedrockConnect/releases/download/$BRC_VERSION/BedrockConnect-1.0-SNAPSHOT.jar -o /docker/brc/BedrockConnect-1.0-SNAPSHOT.jar
